...
SOURCE=$(wildcard src/*.cpp) $(wildcard src/window/*.cpp) $(wildcard src/gameObjects/*.cpp) $(wildcard src/gameObjects/objects2D/*.cpp) $(wildcard src/gameObjects/colliders/*.cpp) $(wildcard src/gameObjects/menuItems/*.cpp) $(wildcard src/gameObjects/objects3D/*.cpp) $(wildcard src/gameObjects/lights/light.cpp) $(wildcard src/ecs/*.cpp)
